		...
		<fieldset>
			<div class="control-group">
				...
				<div class="controls">
					...
					<select tabindex="1" class="typeahead" style="width:350px;" id="searchs" name="searchs">
	                    <option value="xx">All</option>
	                    <option value="1">Approve (Barang sudah diproses)</option>
	                    <option value="0" selected="selected">Pending (Barang belum diproses)</option>
	                </select>
				</div>
                <label class="control-label" for="typeahead">Tgl Transaksi</label>
                <div class="controls">
                    <input type="text" class="dtpicker" id="ol_red_from" name="from" placeholder="From" value="<?php echo $from; ?>" /> 
                    &nbsp;<input type="text" class="dtpicker" id="ol_red_to" name="to" placeholder="To" value="<?php echo $to; ?>" />
