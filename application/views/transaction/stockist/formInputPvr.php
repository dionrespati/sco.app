            ...
            <fieldset>
              <div class="control-group">
                ...
                <table width="100%"class="table table-striped table-bordered">
                        <tr>
                            <thead>
                              <th colspan="4">Input Product Voucher / PVR</th>
                            </thead>  
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td>
                            <input tabindex="3" type="text" style="width: 200px;" id="vchno" name="vch_no"
                              placeholder="Wajib Di isi" onchange="Stockist.get_pvr_info()" />
                              <input type="button" value="Tambah Voucher" onclick="Stockist.get_pvr_info()" class="btn btn-mini btn-success">
                          </td>
                        </tr>
                ...
                <table width="100%" class="table table-striped table-bordered"> <!-- voucher table -->
                  ...
                  <tbody id="SS">
                    ...
                    <input type="hidden" name="xhd" value="0">
                    <input type="hidden" name="isPrdpromo" value="0">
                  </tbody>
                </table> <!-- voucher table -->
...
<script>
  ...
  function save_pvr_sales() {
    ...
    $("input[type=button]").attr("disabled", "disabled");
      ...
      $.post(All.get_url("sales/pvr2/save"), $("#frm_ttp").serialize(), function (hasil) {
