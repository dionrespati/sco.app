				...
				<tr>
					...
					<td>&nbsp;</td>
							...
							<tr>
								...
								<td><input tabindex="29" value="<?php echo $submit_value; ?>" type="button" class="btn btn-primary span20" onclick="Stockist.saveTrxStockist('<?php echo $form_action; ?>',this.form.id)"/></td>
								<td colspan="6">&nbsp;</td>
							</tr>
			</tbody>
		</table>
	...
	<div id="formDua" style="display:none;"></div>
</form>