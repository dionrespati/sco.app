...
<form id="salesSubStockist" class="formSales">
	<table width="100%" class="table table-striped table-bordered bootstrap-datatable datatable">
		...
		<tr>
			...
			<td width="45%">
			<input tabindex="1" type="text" class="span12 typeahead" id="sc_dfno"  name="sc_dfno" value="<?php echo $sc_dfno; ?>" onchange="Stockist.getStkScType(this)" />
			<input type="hidden" id="sctype" name="sctype" value="<?php echo $sctype; ?>" />
			</td>
			<td width="15%">No Trx</td>
			<td>
		...
		<tr>
			<td> C/O Stockist </td>
			<td>
			<input tabindex="2" type="text" class="span12 typeahead" id="sc_co"  name="sc_co" value="<?php echo $sc_co; ?>"  onchange="Stockist.getStkScType(this)" />
		...
		<tr>
			<td>Nama C/O Stockist </td>
			<td>
			<input readonly="readonly" type="text" class="span12 typeahead" id="sc_co_name"  name="sc_co_name" value="<?php echo $sc_conm; ?>" />
			</td>
			<td>Periode Bonus</td>
			<td>
