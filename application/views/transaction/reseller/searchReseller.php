  ...
  <tbody>
    <?php
      ...
      foreach($hasil as $list) {
        $urlUpdInv = "All.ajaxShowDetailonNextForm('reseller/updateInv/$list->trcd')";
        $urlviewInv = "javascript:All.ajaxShowDetailonNextForm('reseller/listInv/$list->trcd')";
    ?>
        <tr>
          <td style="text-align: right;"><?php echo $no; ?></td>
          <td style="text-align: center;"><?php echo $list->trcd;?></td>
          <td style="text-align: center;"><?php echo $list->registerdt;?></td>
          <td><?php echo $list->nama_reseller;?></td>
          <td><?php echo $list->nama_member;?></td>
          ...
          <?php
            ...
            if($list->kw_no === null) {
              ...
              echo "<td style=\"text-align: center;\"><input type=\"button\" class=\"btn btn-mini btn-primary\" value=\"Tambah Invoice\" onclick=\"$urlUpdInv\" /></td>";
            } else {  
