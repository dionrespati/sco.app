...
<form id="simpanCN">
  ...
  <table width="100%" class="table table-striped table-bordered">
	...
	<table class="table table-striped table-bordered" width="100%">
      ...
      <?php
        ...
        if($listVch !== null) {
          ...
          foreach($listVch as $dtavch1) {
            echo "<tr id=\"tdPayId$jvch\">";
            echo "<td><div align=\"center\"><input id=\"byrPayType$jvch\" readonly=\"readonly\"  type=\"hidden\" class=\"span12 typeahead\" name=\"byrPayType[]\" value=\"$dtavch1->paytype\"/>";
            echo "<input id=\"byrPayName$jvch\" readonly=readonly  type=\"hidden\" class=\"span12 typeahead\" name=byrPayName[] value=\"$dtavch1->payDesc\"/>$dtavch1->payDesc</div></td>";
            echo "<td><div align=\"right\"><input id=\"byrAmount$jvch\" readonly=readonly  type=\"hidden\" class=\"span12 typeahead\" name=byrAmount[] value=\"$dtavch1->balamt\"/>".number_format($dtavch1->balamt, 0, ",",".")."</div></td>";
            echo "<td><div align=\"right\"><input id=\"byrIncPay$jvch\" readonly=readonly  type=\"hidden\" class=\"span12 typeahead\" name=byrIncPay[] value=\"$dtavch1->trcd\"/>$dtavch1->trcd</div></td>";
            echo "<td><div align=\"right\"><input id=\"byrBalamt$jvch\" readonly=readonly  type=\"hidden\" class=\"span12 typeahead\" name=byrBalamt[] value=\"$dtavch1->balamt\"/></td>";
            echo "<td><input id=\"byrSisa\" type=\"text\" readonly=\"readonly\" style=\"text-align: right;\" class=\"span20\" name=\"byrSisa[]\" value=\"0\" /></div></td>";
            echo "<td>&nbsp;</td>";
            echo "</tr>";
            $jvch++;

            $total_vch += $dtavch1->balamt;
          }

          $sisa = $total_dpx - $total_vch;
          $sisaTotalCash = $listVch[0]->total_csh;
        }
      ?>
		</tbody>
		<tbody id="sisaBayar">
			<tr>
				...
				<td>
					 <div id="sisaHrsDibayarReal" style="text-align:right;"><?php echo number_format($sisaTotalCash, 0, ",","."); ?></div>
				</td>
				<td colspan="4">&nbsp;</td>
			</tr>				
		</tbody>
	...
	<input type="hidden" id="recBayar" name="recBayar" value="<?php $jvch; ?>" />
<?php
...
<input type="hidden" id="sisaHrsBayar" name="sisaHrsBayar" value = "<?php echo $sisa; ?>" />
<input type="hidden" id="sisaTotalCash" name="sisaTotalCash" value = "<?php echo $sisaTotalCash; ?>" />
<input type="hidden" id="totalVch" name="totalVch" value = "<?php echo $total_vch; ?>" />
...
<script>
  var cnms = {
    ...
    tot_bayar : parseInt($(All.get_active_tab() + " #totalVch").val()),
    sisa_bayar : parseInt($(All.get_active_tab() + " #sisaTotalCash").val()),
    //sisa_cash_pvr: parseInt($(All.get_active_tab() + " #sisaTotalCash").val()),
    list_payment: [],
