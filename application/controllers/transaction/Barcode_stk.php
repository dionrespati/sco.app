...
class barcode_stk extends MY_Controller {
	public function __construct() {
	    parent::__construct();
		$this->folderView = "transaction/barcode/";
		$this->load->model('transaction/barcode_model', 'm_barcode');
	}
	...
	public function formStockBarcode() {
        ...
        if($this->username != null) {
           ...
           $data['to'] 	= date("Y-m-d");
		   $data['stk_barcode_opt'] = $this->m_barcode->getListStkbarMenu($this->groupid);
